...
# Update stock data and description
@app.callback(
...
def update_data(n, stock_code):
    ...
    try:
        ...
        # Check if the ticker information contains the necessary fields
        if 'longBusinessSummary' in sinfo and 'logo_url' in sinfo:
            return sinfo['logo_url'], sinfo['shortName'], sinfo['longBusinessSummary']
        else:
            # If necessary information is missing, return an error message
            return 'https://www.linkpicture.com/q/stonks.jpg', 'Invalid Ticker', 'Please check the ticker symbol.'
    except (ValueError, KeyError, TypeError, Exception) as e:
        # If an error occurs (e.g., invalid ticker or network issue), return a default error message
